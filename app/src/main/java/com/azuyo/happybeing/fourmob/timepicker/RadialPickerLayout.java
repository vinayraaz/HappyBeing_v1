package com.azuyo.happybeing.fourmob.timepicker;
...
import com.azuyo.happybeing.fourmob.datepicker.Utils;
...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    public RadialPickerLayout(Context context, AttributeSet attrs) {
        ...
        mGrayBox.setBackgroundColor(getResources().getColor(R.color.app_blue));
