...
public class CustomKnowledgeHubAdapter extends BaseAdapter {
    ...
    public CustomKnowledgeHubAdapter(Context context, List<AudioFilesInfo> mList, OnItemSelectedListener onItemSelectedListener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.custom_knowledge_hub_files_layout, parent, false);
            RelativeLayout linearLayout = (RelativeLayout) view.findViewById(R.id.complete_layout);
            progressBar = (ProgressBar) view.findViewById(R.id.progressBar);
            TextView title = (TextView) view.findViewById(R.id.option_title);
            download_icon = (ImageView) view.findViewById(R.id.next_icon);
