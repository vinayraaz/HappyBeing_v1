...
import com.azuyo.happybeing.Utils.ShowNotification;
...
public class Alarm extends BroadcastReceiver
{
    ...
    private void setNetDayAlarm(Context c) {
        ...
        if (cursor.getCount() > 0) {
            ...
            mindGymAffirmationsTime = cursor.getLong(cursor.getColumnIndex("RELAX_START_TIME"));
        }
        ...
        contentValues.put("RELAX_START_TIME", calendar.getTimeInMillis());
        if (db_id != -1 ) {
    ...
    {
        //Log.i("Alarm","In Set alarm method of alarm "+millisec);
