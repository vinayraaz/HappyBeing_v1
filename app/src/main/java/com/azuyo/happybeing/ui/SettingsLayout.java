...
public class SettingsLayout extends BaseActivity implements View.OnClickListener {
            ...
            case R.id.saveText:
                if (user_login.equalsIgnoreCase("true")){
                    ...
                    android.support.v7.app.AlertDialog.Builder builder1 = new
                            android.support.v7.app.AlertDialog.Builder(SettingsLayout.this);
                    ...
                    builder1.setPositiveButton(
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    dialog.cancel();
                                    Intent i2 = new Intent(SettingsLayout.this, SignInActivity.class);
                                    startActivity(i2);
                                    finish();
                                }
                            });
